...
public class ObjectController : MonoBehaviour
{
    ...
    /// </summary>
    public Material GazedAtMaterial = null;
    ...
    public void Start()
    {
        this.InactiveMaterial = new Material(Shader.Find("Standard"));
        this.GazedAtMaterial = new Material(Shader.Find("Standard"));
        
        this.GazedAtMaterial.color = Color.red;
        this.InactiveMaterial.color = Color.white;

        //this._startingPosition = this.transform.parent.localPosition;
